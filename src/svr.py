...
#Номера месяцев для данных по юр. лицам
...
#Среднемесячная температура в данные месяцы
...
#Номера месяцев для данных по физ. лицам
...
#Электропотребление в соответствующие месяцы у юридических лиц
...
#Электропотребление в соответствующие месяцы у физических лиц
